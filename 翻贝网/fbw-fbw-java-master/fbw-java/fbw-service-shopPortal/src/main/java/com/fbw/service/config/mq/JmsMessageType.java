...
public class JmsMessageType
{
     ...
     * 买单更新商户信息
     */
    private final String PORTAL_UPDATE_USER_GROUND_STATUS_QUEUE = "protal-update-user-ground-status-queue";
     ...
     * @see [类、类#方法、类#成员]
     */
    @Bean(name = "updateUserGroundStatus")
    public Queue updateUserGroundStatus()
    {
        return new ActiveMQQueue(PORTAL_UPDATE_USER_GROUND_STATUS_QUEUE);
    }
