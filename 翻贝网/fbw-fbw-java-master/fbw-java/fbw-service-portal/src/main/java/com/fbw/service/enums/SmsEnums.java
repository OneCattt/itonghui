...
public enum SmsEnums
{
     ...
     * 短信提醒
     */
    COMMON_DICT_SMS_1103010002_CONF("SMS_103010002", "{methodName:'*methodName*'}"),
     ...
     */
    COMMON_DICT_SMS_64580023_CONF("SMS_64580023", "{shopname:'*shopname*',cardholder:'*cardholder*',bankcard:'*bankcard*'}"),

    /**
     * 商家上线短信通知SMS_64535035
     */
    COMMON_DICT_SMS_64535035_CONF("SMS_64535035", "{shopname:'*shopname*',cardholder:'*cardholder*',bankcard:'*bankcard*'}"),

    /**
     * 财务结款提醒SMS_48320121
     */
    COMMON_DICT_SMS_48320121_CONF("SMS_48320121", "{shopname:'*shopname*',money:'*money*',banknumber:'*banknumber*'}"),

    /**
     * 翻贝网用户订阅提醒SMS_39190380
     */
    COMMON_DICT_SMS_39190380_CONF("SMS_39190380", "{name:'*name*'}"),

    /**
     * 翻贝日商家提醒SMS_39335358
     */
    COMMON_DICT_SMS_39335358_CONF("SMS_39335358", "{name:'*name*'}"),

    /**
     * 商户消费提醒SMS_34870048
     */
    COMMON_DICT_SMS_34870048_CONF("SMS_34870048", "{money:'*money*'}"),
