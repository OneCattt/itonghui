...
public interface RechargeFeignClient
{
    ...
    public Map<String, Object> sendAppAiPay(@PathVariable("rechargeOrderNumber") String rechargeOrderNumber,
            @PathVariable("money") BigDecimal money, @PathVariable("mobiles") String mobiles);
    ...
    public Map<String, Object> sendAppWechatPay(@PathVariable("rechargeOrderNumber") String rechargeOrderNumber,
            @PathVariable("money") BigDecimal money, @PathVariable("reqestIp") String reqestIp,
            @PathVariable("mobiles") String mobiles);

    /**
     * <功能详细描述>通过手机号获取90天内充值列表
     * @param mobile
     * @return
     * @see [类、类#方法、类#成员]
     */
     ...
     * @see [类、类#方法、类#成员]
     */
    @RequestMapping(value = "/recharge/getRechargeRecordByOrderNum?orderNum={orderNum}")
    public RechargeEntity getRechargeRecordByOrderNum(@PathVariable("orderNum") String orderNum);
