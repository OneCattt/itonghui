...
public class JmsMessageType
{
     ...
     * 语音短信发送信息
     */
    private final String PORTAL_VOICE_SMS_QUEUE = "portal-voice-sms-queue";
     ...
     * @see [类、类#方法、类#成员]
     */
    @Bean(name = "sendVoiceMsg")
    public Queue sendVoiceMsg()
    {
        return new ActiveMQQueue(PORTAL_VOICE_SMS_QUEUE);
    }
}
