            ...
            "1102"), ALIPAY_ENCODING_ERROR("充值阿里转码异常", "1103"), WECHAT_REQ_PARM_ERROR("微信异步回调请求报文为空",
                    "1104"), WECHAT_REQ_SIGN_ERROR("微信异步回调请求验签错误", "1105"), XML_CONVERT_MAP_ERROR("XML转换MAP异常",
                            "1106"), WECHAT_UNIFIED_ORDER_FAIL("微信统一下单失败", "1107"), WECHAT_GET_RETURN_MSG_ERROR(
                                    "微信充值获取返回报文异常",
                                    "1108"), WECHAT_NOTIFY_PAY_ERROR("微信充值通知支付失败", "1109"), WECHAT_UPDATE_ORDER_ERROR(
                                            "微信充值更新订单错误",
                                            "1110"), DB_QUERY_ERROR("数据库查询异常", "1111"), DB_UPDATE_ERROR("数据库更新异常",
                                                    "1112"), DB_SAVE_ERROR("数据库保存异常", "1113"), ORDER_NOT_EXICT("订单不存在",
                                                            "1114"), ORDER_PAY_SUCCESS("订单重复",
                                                                    "1115"), RECHARGE_DB_UPDATE_ORDER_ERROR(
                                                                            "数据库更新充值订单状态异常",
                                                                            "1116"), RECHARGE_DB_UPDATE_BALANCE_ERROR(
                                                                                    "数据库更新充值余额异常",
                                                                                    "1117"), RECHARGE_ALIPAY_UPDATE_ORDER_ERROR(
                                                                                            "支付宝充值更新订单错误",
                                                                                            "1118"), RECHARGE_WECHAT_SIGN_NULL_ERROR(
                                                                                                    "微信异步回调请求签名为空",
                                                                                                    "1119"), RECHARGE_CALL_BACK_PARM_ERROR(
                                                                                                            "充值异步回调参数验证错误",
                                                                                                            "1120");
