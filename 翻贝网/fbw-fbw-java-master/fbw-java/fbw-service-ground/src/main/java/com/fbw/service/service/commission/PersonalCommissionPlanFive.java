...
/**
 * 
 * <功能详细描述>每个有效地推的注册用户 0 元，且该用户首笔金额满 0 元以上的充值按 0 元／单计为地推充值收入
 * @author JACK HUANG
 ...
 */
@Service
public class PersonalCommissionPlanFive extends AbstractCommissionSchemeSuper
{
    ...
    public CommissionResEntity getCommissionFee(CommissionReqEntity commissionReqEntity)
    {
        ...
        // 用户首笔金额满 0 元以上的充值按 0 元／单计为地推充值收入
        if (NomalUtil.AgreaterThanB(commissionReqEntity.getRechargeMoney(),
                groundPlanConfEntity.getEachFirstRechargeFeeLimit()))
        {
